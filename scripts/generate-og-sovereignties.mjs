// Generate the Open Graph tile for /sovereignties.
// Renders an SVG to a 1200x630 PNG at public/images/og-sovereignties.{svg,png}.
//
// Re-run when the title / tagline / palette changes:
//   node scripts/generate-og-sovereignties.mjs
//
// Same approach and constraints as generate-og.mjs (system-font fallbacks; librsvg
// can't reliably load web fonts).
...
const SVG_OUT = path.join(ROOT, 'public/images/og-sovereignties.svg');
const PNG_OUT = path.join(ROOT, 'public/images/og-sovereignties.png');
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  ...
  <text x="96" y="150"
        ...
        fill="#454E41">
    CIVIC INTERPLAY · A LIVE MAP
  </text>

  <!-- Title -->
  <text x="96" y="300"
        font-family="Helvetica Neue, Helvetica, Arial, sans-serif"
        font-size="100" font-weight="300" letter-spacing="4"
        fill="#1c1917">AI <tspan fill="#7D50BD">SOVEREIGNTIES</tspan></text>
  ...
  <text x="100" y="380"
    ...
    The infrastructure behind AI in Australia,
  </text>
  <text x="100" y="422"
        font-family="Georgia, serif"
        font-size="30" font-style="italic"
        fill="rgba(28,25,23,0.72)">
    and the debate forming around it.
  </text>
  ...
  <text x="1104" y="557"
    ...
    CIVICINTERPLAY.IO/SOVEREIGNTIES
  </text>
</svg>
`;

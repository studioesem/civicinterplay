...
The magical properties of cloud computing and agential intelligence seem to be descending from their ethereal states. They are now encroaching the grounds we guard closely - for housing, for water, for energy, for life. 
...
The point here is therefore not to oppose the AI Sovereignty agenda, but instead to understand that how it lands on the soil, how it fosters a local innovation ecosystem or simply extracts minerals, land, water and energy, are central to the kind of AI Sovereignty being built. 
...
Please note: This work is in the *emergent-state*. Do get in touch if you would like to collaborate; its an open field. 
